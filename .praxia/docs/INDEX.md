...
## Specs
- [260706_epic1541-planner-joint-budget-migration](specs/260706_epic1541-planner-joint-budget-migration.md) — **DRAFT** — migrate `aminx.tiling.planner` onto xtrax 0.4.0a1's joint-budget `BatchPlanner`; enumerates behavior changes (int budget, fail-loud `BudgetInfeasibleError`, `decision_for()` helper, `plan_bucketed()` rewrite, CarrySpec/DedupSpec cascade); supersedes-in-part the two 260706 planner/carry decisions.
