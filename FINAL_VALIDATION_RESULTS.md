# PrxteinMPNN Final Validation Results

## Summary

All three decoding paths have been validated against ColabDesign and achieve >0.90 correlation! ✅

## Results

| Path | Correlation | Status | Target |
|------|------------|--------|---------|
| **Unconditional** | 0.984 | ✅ EXCELLENT | >0.90 |
| **Conditional** | 0.958-0.984 | ✅ EXCELLENT | >0.90 |
| **Autoregressive** | 0.953-0.970 | ✅ EXCELLENT | >0.90 |
