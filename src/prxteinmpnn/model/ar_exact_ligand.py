"""Stacked wave-parallel autoregressive sampler for LigandMPNN ``state_vmap_exact``.
...
def run_sample_ar_exact_ligand(  # noqa: PLR0915
  ...
  def lig_encode_one(coords, ma, ri, ci, yy, yt, ym, hk):  # noqa: ANN001, ANN202
    return ligand_encode_stack_row(model, coords, ma, ri, ci, yy, yt, ym, hk)
  ...
  ah = jnp.zeros((s_dim, num_dec, p_pad, model.node_features_dim), dtype=log_dtype)
