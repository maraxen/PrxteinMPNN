...
class ModelProtocol(Protocol):
  ...
  def __call__(self, key: PRNGKeyArray, inputs: ModelInputs, **kwargs: Any) -> Any:
    ...
    Callers should prefer this over specialized _from_payload methods when possible.
    Implementations should dispatch to the appropriate internal path based on
    the type of ``inputs``.
    """
    ...
